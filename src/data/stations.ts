...
export const INTERCHANGE_LINES: Record<string, string[]> = {
  ...
  NS27: ['TEL', 'CCL'], TE20: ['NSL', 'CCL'], CE2: ['NSL', 'TEL'],
  // MacPherson: CCL + DTL
  CC10: ['DTL'], DT26: ['CCL'],
  // Tampines: EWL + DTL
  EW2: ['DTL'], DT32: ['EWL'],
  ...
  // Orchard: NSL + TEL
  NS22: ['TEL'], TE14: ['NSL'],
  // Expo: EWL (Changi Airport Branch) + DTL
  CG1: ['DTL'], DT35: ['EWL'],
};
...
export const LINE_STATIONS: Record<string, string[]> = {
  ...
  EWL: ['EW1', 'EW2', 'EW3', 'EW4', 'CG1', 'CG2', 'EW5', 'EW6', 'EW7', 'EW8', 'EW9', 'EW10', 'EW11', 'EW12', 'EW13', 'EW14', 'EW15', 'EW16', 'EW17', 'EW18', 'EW19', 'EW20', 'EW21', 'EW22', 'EW23', 'EW24', 'EW25', 'EW26', 'EW27', 'EW28', 'EW29', 'EW30', 'EW31', 'EW32', 'EW33'],
